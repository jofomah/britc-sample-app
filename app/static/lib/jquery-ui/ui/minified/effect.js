...
!function (a) {
    ...
    return a.effects = {effect: {}}, function (a, b) {
        ...
        a.expr && a.expr.filters && a.expr.filters.animated && (a.expr.filters.animated = function (b) {
            ...
            version: "1.12.0", define: function (b, c, d) {
            ...
            effect: function () {
                ...
                var c = e.apply(this, arguments), f = a.effects.effect[c.effect], g = f.mode, h = c.queue, i = h || "fx", j = c.complete, k = c.mode, l = [], m = function (b) {
